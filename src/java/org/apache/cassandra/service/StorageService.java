...
public class StorageService extends NotificationBroadcasterSupport implements IEndpointStateChangeSubscriber, StorageServiceMBean
{
    ...
    public void startMppExtensionServices()
    {
        ...
        try {
            daemon.startMppExtensionServices();
        }
        catch (Exception e)
        {
            throw new RuntimeException("Error starting MPP extension services: " + e.getMessage());
        }
    }
    ...
    public void stopMppExtensionServices()
    {
        ...
        daemon.stopMppExtensionServices();
    }
    ...
    public boolean isMppExtensionServicesRunning()
    {
        ...
        return daemon.isMppExtensionServicesRunning();
    }
    ...
    public void stopTransports()
    {
        ...
        if (isMppExtensionServicesRunning())
        {
            logger.error("Stopping MPP extension services");
            stopMppExtensionServices();
        }
    }
