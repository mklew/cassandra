...
public class LoggingMessageHandler implements MppMessageHandler
{
    ...
    {
        CompletableFuture<MppResponseMessage> f = new CompletableFuture<>();
        logger.info("LoggingMessageHandler has received message: " + requestMessage);
        f.complete(new EmptyMppMessageResponse());
        return f;
    }
}
